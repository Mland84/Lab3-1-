...
public class Hand_Test {
	...
	public void TestRodyalFlush() {
		...
		h.AddToCardsInHand(new Card(eRank.TEN, eSuit.CLUBS,1));
		h.AddToCardsInHand(new Card(eRank.JACK, eSuit.CLUBS,1));
		h.AddToCardsInHand(new Card(eRank.QUEEN, eSuit.CLUBS,1));
		h.AddToCardsInHand(new Card(eRank.KING, eSuit.CLUBS,1));
		h.AddToCardsInHand(new Card(eRank.ACE, eSuit.CLUBS,1));
	...
	public void TestStraightFlush() {
		...
		h.AddToCardsInHand(new Card(eRank.QUEEN, eSuit.CLUBS,1));
		h.AddToCardsInHand(new Card(eRank.KING, eSuit.CLUBS,1));
		h.AddToCardsInHand(new Card(eRank.NINE, eSuit.CLUBS,1));
